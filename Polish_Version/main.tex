...
wnioski na temat implementacji takiego rozwiązania w grach komercyjnych na podstawie tego projektu.
...
\begin{figure}[H]
  \hfill
  \subfigure[Funkcja Heurestic() oraz CollectObservations()]{\includegraphics[width=0.45\textwidth]{Heurestic_Collect.JPG}}
  \hfill
  \subfigure[Funkcja OnActionReceived()]{\includegraphics[width=0.45\textwidth]{OnActionReceived.JPG}}
  \hfill
  \subfigure[Funkcja WriteDiscreteMask()]{\includegraphics[width=0.45\textwidth]{Mask.JPG}}
  \hfill
  \subfigure[Funkcja OnEpisodeBegin()]{\includegraphics[width=0.45\textwidth]{Episode.JPG}}
  \hfill
